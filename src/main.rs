...
/// Render a rectangle of the Mandelbrot set into a
/// buffer of pixels
///
/// The `bounds` argument gives the width and height
/// of the buffer `pixels`, which holds one grayscale
/// pixel per byte
/// The `upper_left` and `upper_right` arguments
/// specify points on the complex plane corresponding
